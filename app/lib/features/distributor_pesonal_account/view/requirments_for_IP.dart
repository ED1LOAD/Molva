...
import 'package:app/features/distributor_pesonal_account/view/distributor_doc_props.dart';
...
class CompanyRequirementsIP extends StatelessWidget {
  final _formKey = GlobalKey<FormState>();

  CompanyRequirementsIP({super.key});
