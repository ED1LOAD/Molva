...
class RegistrationPage extends StatefulWidget {
  ...
  @override
  RegistrationPageAgentState createState() => RegistrationPageAgentState();
}

class RegistrationPageAgentState extends State<RegistrationPage> {
  bool isPerson = false;
  ...
  Future<void> _registerAndLogin(BuildContext context) async {
    try {
      ...
      await _registrationService.registerAndLogin(
          ...
          userType);
      Navigator.of(context).pushNamedAndRemoveUntil('/stub', (route) => false);
    } catch (e) {
